     ...
     <div className=''>
      ...
      <div className="  text-richblack-5  w-11/12 mx-auto  py-12  ">
       ...
       <div className="my-5 text-4xl font-bold justify-center flex">
        ...
        <div className="my-10 ">
              <h5 className="font-bold text-2xl my-5"> 1. COLLECTION OF INFORMATION </h5>
                <p className=""> 
                    As a visitor, you can browse through our Website to find out more about Upskills. You are not required to provide us with any Personal Data if you are merely a visitor. When you visit the Site, we collect and store certain information in order to increase security, analyse developments and administer the Website with
                    a view to help us in making customer experience better. We utilise this information to analyse traffic patterns on our Website so as to make it more beneficial 
                    for our visitors. We collect your Personal Data only when you register with us, when you are interested in obtaining information regarding our products and    services, when you participate in activities on our Website or contact us. We will only collect your Personal Information if there is a proper and valid reason
                     for doing so, for instance : to comply with our regulatory and legal obligations; for the performance of our contract with you or to take the required steps at your request before entering into a legal contract; for our legitimate interests or where you have given consent. A legitimate interest is when we have a valid commercial or business reason to use your information. In certain cases, we may also have a legal obligation to collect personal data from you or may otherwise need the personal information to protect your interests or those of another individual (for instance, in order to prevent payment fraud or confirm your identity). Our primary objective in collecting your Personal Information is to provide you a safe, effective, seamless and customized experience. This allows us to provide online courses, study material and tutorials that most likely meet your needs and to customize our Website to make your experience easier, better and safer. The information we gather from you helps us personalize and continually improve customer experience at our Website. We do not voluntarily make this information available to any third parties, nor do we use it for any other objective, except as set out herein. In order to register on our website or complete the purchase process of one of our courses, we may collect the following information that you will voluntarily provide to us through one of our contact forms, chat or phone session, such as:
                    <br></br>
                    <br></br>
                    1. Information pertaining to personal details, like name, email id, photograph, contact address, contact number, IP address or geographic location
                    <br></br>
                    <br></br>
                    2. Information pertaining to identity, like your mark-sheets, Aadhar /Voter ID/ Passport details;
                    <br></br>
                    <br></br>
                    3. Information pertaining to billing, like credit/debit card number and billing address;
                    <br></br>
                    <br></br>
                    4. Username or password;
                    <br></br>
                    <br></br>
                    5. Ratings or reviews, syllabus/ course preferences, account settings; and
                    <br></br>
                    <br></br>
                    6. Information provided to us through interaction with customer service, surveys or promotions.
                    <br></br>
                    <br></br>

                    We collect data about your interactions with us and also the information regarding the device (Laptop, computer, mobile, etc) used to access our service. This information contains your activity on our Website, and search queries; your interactions details with customer service, and if you call us , your contact number 
                    and recordings of your calls; device IDs or other unique identifiers, device and software characteristics, connection information, statistics regarding page 
                    views, referral URLs, IP address, browser and web server log information, and information collected via the use of cookies. With the aid of back end applications, we strive to provide better services and quality interaction with teachers, depending on your interest. We may also seek this information at other instances, such 
                    as when you enter contests or other marketing promotions sponsored by us and/or our partners. If you use a functionality that requires fee payment, options will appear. In case of payments via credit or debit card, we will redirect you to registered payment gateway razorpay or paytm. You may store and save your payment details like card numbers with the gateway. We cannot access this data. All payment transactions are processed through secure payment gateway providers. When 
                    you access any of our paid products, we store information about the web pages on our servers. This helps us to track items that have been completed by you, and 
                    those that you need to see. The user’s full name and his/her display picture can be publicly displayed on the Website. Upskills can seek more information regarding billing information, address, certificates, etc depending on what profile and what services they are seeking. Upskills can use technologies like cookies, clear gifs, log files, etc to help understand how you interact with our site and services, so as to render a better experience.
                </p>   
        ...
        <div className="my-10">
                <h1  className="font-bold text-2xl my-5"> 3. COMMUNITY</h1>
                <p className="">
                 Upskills is a community, wherein we offer a number of features that allow members to connect and communicate in public or semi-public spaces, such as Forums and Teams. Please use your judgment before posting in these community spaces or sharing your personal information with others on Upskills. You should be aware that any personal information you submit there can be read, collected, or used by others, or could be used to send you unsolicited messages.
                </p>
        ...
        <div className="my-10">
                     <h1  className="font-bold text-2xl my-5"> 4. SHARING AND DISCLOSING PERSONAL INFORMATION</h1>
                     <p className="text-xl">
        ...
        <div className="my-10">
                <h1  className="font-bold text-2xl my-5">  5. NOTE TO OUR USERS IN EUROPE:</h1>
                <p className="">
        ...
        <div className="my-10">
               <h1  className="font-bold text-2xl my-5">   7. CHANGES TO THIS POLICY</h1>
               <p className="">
                  Upskills reserves the right to change this Privacy Policy as we may deem necessary from time to time or as may be required by law. Any changes will be immediately posted on the Web Site and you are deemed to have accepted the terms of the Policy on your first use of the Web Site following the alterations.
               </p>
